          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    title: const Text(Strings.runImmediately),
...
class _AnimatedHeroStatsGraphState extends State<AnimatedHeroStatsGraph>
  ...
  @override
  Widget build(BuildContext context) {
    final style = Theme.of(context).textTheme.headline6 ?? const TextStyle();
    final color = Theme.of(context).primaryColor.withOpacity(0.3);
